 ...
 */
    ...
    (() => {
        ...
        const inputMasks = document.querySelectorAll(".form-delivery__input_phone");
        ...
        function rangeInit() {
            let stepSlider = document.querySelector("#range");
            ...
            var stepSliderValueElement = document.querySelector(".form-delivery__display");
            stepSlider.noUiSlider.on("update", (function(values, handle) {
                stepSliderValueElement.value = Math.trunc(values[handle]) + " " + "литров";
            }));
        }
        rangeInit();
        ...
        function initSliders() {
            if (document.querySelector(".certificates__slider")) new core(".certificates__slider", {
                ...
                speed: 800,
                navigation: {
                    prevEl: ".top-items__swiper-button-prev_1",
                    nextEl: ".top-items__swiper-button-next_1"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
            ...
            if (document.querySelector(".our-partners__slider")) new core(".our-partners__slider", {
            ...
            if (document.querySelector(".reviews__slider")) new core(".reviews__slider", {
                ...
                speed: 800,
                navigation: {
                    prevEl: ".top-items__swiper-button-prev_2",
                    nextEl: ".top-items__swiper-button-next_2"
                },
                breakpoints: {
                    320: {
                        slidesPerView: 1,
